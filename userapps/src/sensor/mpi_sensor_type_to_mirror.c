...
/* Appended at CSI0 block end so toggling 4LANE does not shift CSI1/CSI2 values */
    ...
    {.type = OV13850_MIPI_CSI0_4LANE_1920X1080_30FPS_10BIT_LINEAR, .mirror = 0},
    {.type = OV13850_MIPI_CSI0_4LANE_1920X1080_60FPS_10BIT_LINEAR, .mirror = 0},
    {.type = OV13850_MIPI_CSI0_4LANE_2112X1568_30FPS_10BIT_LINEAR, .mirror = 0},
    {.type = OV13850_MIPI_CSI0_4LANE_2112X1568_60FPS_10BIT_LINEAR, .mirror = 0},
#endif // CONFIG_MPP_ENABLE_CSI_DEV_0
...
#if defined (CONFIG_MPP_ENABLE_CSI_DEV_0)
    {.type = IMX290_MIPI_CSI0_2LANE_1920X1080_30FPS_12BIT_LINEAR, .mirror = 0},
#endif // CONFIG_MPP_ENABLE_CSI_DEV_0
#if defined (CONFIG_MPP_ENABLE_CSI_DEV_1)
    {.type = IMX290_MIPI_CSI1_2LANE_1920X1080_30FPS_12BIT_LINEAR, .mirror = 0},
#endif // CONFIG_MPP_ENABLE_CSI_DEV_1
#if defined (CONFIG_MPP_ENABLE_CSI_DEV_2)
    {.type = IMX290_MIPI_CSI2_2LANE_1920X1080_30FPS_12BIT_LINEAR, .mirror = 0},
#endif // CONFIG_MPP_ENABLE_CSI_DEV_2
