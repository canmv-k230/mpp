...
k_connector_info connector_info_list[] = {
...
#if defined(CONFIG_MPP_DSI_ENABLE_LCD_JD9852)
    {
        ...
        .resolution = {
            .pclk = 6750, // 6750 * 1000 / (240 + 8 + 40 + 16) / (320 + 8 + 20 + 56) = 54.96 fps
            .phyclk = 162000,
            .htotal = (240 + 8 + 40 + 16), // 304
            .hdisplay = 240,
            .hsync_len = 8,
            .hback_porch = 40,
            .hfront_porch = 16,
            .vtotal = (320 + 8 + 20 + 56), // 404
            .vdisplay = 320,
            .vsync_len = 8,
            .vback_porch = 20,
            .vfront_porch = 56,
...
#if defined(CONFIG_MPP_DSI_ENABLE_LCD_AML020T)
    {
        ...
        .resolution = {
            .pclk = 12375, // 12375 * 1000 / (480 + 5 + 20 + 10) / (360 + 5 + 20 + 5) = 61.61 fps
            .phyclk = 148500,
            .htotal = (480 + 5 + 20 + 10), // 515
            .hdisplay = 480,
            .hsync_len = 5,
            .hback_porch = 20,
            .hfront_porch = 10,
            .vtotal = (360 + 5 + 20 + 5), // 390
            .vdisplay = 360,
            .vsync_len = 5,
            .vback_porch = 20,
            .vfront_porch = 5,
