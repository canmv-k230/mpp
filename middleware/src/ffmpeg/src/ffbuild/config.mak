...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=riscv64-unknown-linux-musl --enable-cross-compile --target-os=linux --cc=$(CROSS_COMPILE)gcc --ar=$(CROSS_COMPILE)ar --nm=$(CROSS_COMPILE)nm --ranlib=$(CROSS_COMPILE)ranlib --arch=riscv64 --pkg-config-flags=--static --enable-gpl --extra-cflags='-fPIC -Wno-multichar -Wno-deprecated-declarations -Wno-unused-result -Wno-unused-variable -Wno-format -Wno-return-type -Wno-sign-compare -Wno-unused-label' --enable-nonfree --disable-ffplay --enable-swscale --enable-pthreads --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-x86asm --disable-stripping  --extra-libs=-ldl --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-encoders --enable-encoder=pcm_alaw --enable-encoder=pcm_mulaw --enable-encoder=aac  --enable-encoder=mjpeg --disable-decoders --enable-decoder=h264 --enable-decoder=mjpeg --enable-decoder=hevc --enable-decoder=aac --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --disable-demuxers --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=mjpeg --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=pcm_alaw --enable-demuxer=pcm_mulaw --enable-demuxer=wav --enable-demuxer=rtp --enable-demuxer=rtsp --disable-muxers --enable-muxer=mp4 --enable-muxer=adts --enable-muxer=h264 --enable-muxer=hevc --enable-muxer=mjpeg --enable-muxer=rtp --enable-muxer=rtsp --enable-muxer=pcm_alaw --enable-muxer=pcm_mulaw --enable-muxer=mpegts --enable-demuxer=wav --disable-protocols --enable-protocol=file --enable-protocol=rtp --enable-protocol=rtmp --enable-protocol=udp --enable-protocol=tcp --enable-protocol=http --enable-protocol=hls --disable-bsfs --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-bsf=aac_adtstoasc --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-parser=hevc --enable-parser=mjpeg --enable-parser=bmp --enable-parser=png --disable-avdevice --disable-swscale --disable-iconv --disable-avfilter
prefix=
LIBDIR=$(MPP_MIDDLEWARE_LIB_INSTALL_PATH)
SHLIBDIR=$(MPP_MIDDLEWARE_LIB_INSTALL_PATH)
INCDIR=$(MPP_MIDDLEWARE_INC_INSTALL_PATH)
BINDIR=$(SDK_RTSMART_BUILD_DIR)/mpp/middleware/bin
DATADIR=$(SDK_RTSMART_BUILD_DIR)/mpp/middleware/share/ffmpeg
DOCDIR=$(SDK_RTSMART_BUILD_DIR)/mpp/middleware/share/doc/ffmpeg
MANDIR=$(SDK_RTSMART_BUILD_DIR)/mpp/middleware/share/man
PKGCONFIGDIR=$(MPP_MIDDLEWARE_LIB_INSTALL_PATH)/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
OBJCC=$(CROSS_COMPILE)gcc
LD=$(CROSS_COMPILE)gcc
DEPCC=$(CROSS_COMPILE)gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=$(CROSS_COMPILE)gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS= -mcmodel=medany -march=rv64imafdcv -mabi=lp64d -Wall -O0 -n --static -fPIC -Wno-multichar -Wno-deprecated-declarations -Wno-unused-result -Wno-unused-variable -Wno-format -Wno-return-type -Wno-sign-compare -Wno-unused-label -I$(MPP_MIDDLEWARE_INC_INSTALL_PATH) -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
OBJCFLAGS=
ASFLAGS=  -fPIC -Wno-multichar -Wno-deprecated-declarations -Wno-unused-result -Wno-unused-variable -Wno-format -Wno-return-type -Wno-sign-compare -Wno-unused-label -I$(MPP_MIDDLEWARE_INC_INSTALL_PATH) -fPIC
...
DEPWINDRES=$(CROSS_COMPILE)gcc
DOXYGEN=doxygen
LDFLAGS=$(LINKFLAG) -Wl,--whole-archive -Wl,--no-whole-archive -n --static -L$(MPP_MIDDLEWARE_LIB_INSTALL_PATH)  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -pthread -lm
