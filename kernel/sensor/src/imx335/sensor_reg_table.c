...
/* 4-lane 2592x1944@30 RAW12 @ 1188 Mbps/lane (VICAP_MIPI_PHY_1200M).
 * Replaces the old incomplete 891 Mbps stubs. Content is the verified
 * 2-lane 2592x1944 table with only LANEMODE 0x3A01 changed 0x01 -> 0x03;
 * PLL/timing (incl. 0x319e=0x01) stay identical to that 2-lane mode. */
static const k_sensor_reg imx335_mipi_4lane_raw12_2592x1944_30fps_mclk_74_25_regs[] = {
    { 0x3000, 0x01 },
    { 0x3002, 0x00 },
    { 0x3a01, 0x03 }, // 4 lane
    { 0x300c, 0xb6 }, // INCK 74.25MHz
    { 0x300d, 0x7f },
    { 0x314c, 0x80 },
    { 0x314d, 0x00 },
    { 0x315a, 0x03 },
...
static const k_sensor_reg imx335_mipi_4lane_raw12_2592x1944_30fps_mclk_24m_regs[] = {
    { 0x3000, 0x01 },
    { 0x3002, 0x00 },
    { 0x3a01, 0x03 }, // 4 lane
    { 0x300c, 0x3b }, // INCK 24MHz
    { 0x300d, 0x2a },
    { 0x314c, 0xc6 },
    { 0x314d, 0x00 },
    { 0x315a, 0x02 },
