...
static k_sensor_ae_info sensor_csi0_ae_info[] = {
     ...
     * Intentionally duplicated across csi*_mode_list (existing style; do not
     * share one static without refactoring all modes together). */
    {
        .frame_length = 1721,
        .cur_frame_length = 1721,
        .one_line_exp_time = 0.000019373,
...
static const k_sensor_mode sensor_csi0_mode_list[] = {
    {
        .index = 0,
        .sensor_type = OV5647_MIPI_CSI0_2592x1944_15FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 2592,
            .bounds_height = 1944,
            .top = 0,
    ...
    {
        .index = 5,
        .sensor_type = OV5647_MIPI_CSI0_640x480_60FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 640,
            .bounds_height = 480,
            .top = 0,
