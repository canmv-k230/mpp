...
static const k_sensor_mode sensor_csi1_mode_list[] = {
    {
        .index = 0,
        .sensor_type = OV5647_MIPI_CSI1_2592x1944_15FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 2592,
            .bounds_height = 1944,
            .top = 0,
    ...
    {
        .index = 1,
        .sensor_type = OV5647_MIPI_CSI1_1920X1080_30FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 1920,
            .bounds_height = 1080,
            .top = 0,
    ...
    {
        .index = 2,
        .sensor_type = OV5647_MIPI_CSI1_1280X960_45FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 1280,
            .bounds_height = 960,
            .top = 0,
    ...
    {
        .index = 3,
        .sensor_type = OV5647_MIPI_CSI1_1280X720_60FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 1280,
            .bounds_height = 720,
            .top = 0,
    ...
    {
        .index = 4,
        .sensor_type = OV5647_MIPI_CSI1_640x480_90FPS_10BIT_LINEAR,
        .size = {
            .bounds_width = 640,
            .bounds_height = 480,
            .top = 0,
