...
/* VGA@90 RAW10: binning + subsample, near-full FOV */
...
/* VGA@60: same as 90fps except VTS 573->860 (1792 x 860 x 60 ≈ 92.5 MHz) */
static const k_sensor_reg ov5647_640x480_60fps_10bpp[] = {
	...
	{0x3802, 0x00},     // y start 12
	{0x3803, 0x0c},
	{0x3804, 0x0a},     //x end = 0xa1f = 2607, x size = 2607 +1 - 24 = 2584
	{0x3805, 0x2f},
	{0x3806, 0x07},     //y end = 0x7a3 = 1955, y size = 1955 +1 - 12 = 1944
	{0x3807, 0xa3},
	{0x3811, 0x04},	//x offset: 4
	{0x3813, 0x02},	//y offset: 2
    {0x3630, 0x2e},
